  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file flex justify-center rounded-lg cursor-pointer w-full relative min-h-[80vh] bg-muted overflow-hidden"
      >
        <input
          ref={fileInputRef}
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative  z-40 bg-muted border flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
